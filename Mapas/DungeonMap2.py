...
class DungeonMap2(AbstractMapa):
    __MATRIX = [
        ...
        'PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP']
    folder = Folder()
    __SPRITE_PATH = folder.create_assets_path(['Mapas', 'Dungeon'], 'sala2.png')
    __MUSIC_PATH = folder.create_sounds_path(['musics'], 'som_ambiente2.ogg')
    ...
    def background_music_path(self):
        return DungeonMap2.__MUSIC_PATH
